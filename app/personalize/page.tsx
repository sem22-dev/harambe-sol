        ...
        <div className="flex flex-col items-center justify-center">
            ...
            <div className="mt-[170px] flex flex-col md:flex-row items-center justify-start gap-12  ">
                <div className="flex flex-col items-center w-[400px]">
                    <h1 className="text-2xl tracking-[0.3em] text-center font-medium py-1">FH - HARAMBE</h1>
                    ...
                    {isEditingName && (
                        <>
                            ...
                            <div>
                                ...
                                <Button className=" ml-4" onClick={() => setIsEditingName(false)}>CONFIRM</Button>
                            </div>
                        </>
                    )}
        ...
        <div className="flex w-fit  flex-col items-center ">
            ...
            <div className="border flex justify-center items-center border-[#444343] overflow-hidden w-8 h-12 rounded-lg shadow-xl relative group">
                ...
                <div 
                    ...
                    style={{
                        background: 'linear-gradient(to bottom, rgba(0,0,0,0.5) 0%, rgba(0,0,0,0.08) 50%, transparent 100%)'
                    }}
                />
                 <div 
